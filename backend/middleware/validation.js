...
const checklistItemSchema = Joi.object({
  ...
  type: Joi.string().required().valid(
    ...
    'dropdown', 'checkbox', 'radio', 'multiImage', 'signature'
  ).messages({
    'any.only': 'Invalid question type. Must be one of: textArea, textField, date, time, dateTime, dropdown, checkbox, radio, multiImage, signature'
  }),
